...
async function buildRomanOS(exampleName = 'hello-world') {
    ...
    const x86Asm = generator.generateBootSector(assembleResult.instructions, assembleResult.data, assembleResult.labels);
...
buildRomanOS(exampleName).catch(error => {
